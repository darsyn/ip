...
class Compatible
{
    ...
    public static function getValidSequences(): array
    {
        return [
            ...
            [pack('H*', '0000000000000000000000007f000001'), pack('H*', '7f000001')],
            [pack('H*', '00000000000000000000000012345678'), pack('H*', '12345678')],
            [pack('H*', '0000000000000000000000007f00a001'), pack('H*', '7f00a001')],
        ];
    }
    ...
    public static function getInvalidSequences(): array
    {
        return [
            ...
            [pack('H*', '0001000000000000000000010b120cab')],
