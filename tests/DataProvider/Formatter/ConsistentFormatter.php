...
class ConsistentFormatter
{
    ...
    public static function getValidBinarySequences()
    {
        return [
            ...
            [\pack('H*', '20010db80000001fffffffffffffffff'), '2001:db8:0:1f:ffff:ffff:ffff:ffff'],
            [\pack('H*', '00000001000100010001000100010001'), '0:1:1:1:1:1:1:1'],
            [\pack('H*', '00010001000100010000000100010001'), '1:1:1:1:0:1:1:1'],
            [\pack('H*', '00010001000100010001000100010000'), '1:1:1:1:1:1:1:0'],
        ];
    }
