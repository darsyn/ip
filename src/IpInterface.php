...
interface IpInterface
{
     ...
     * Only the canonical 6to4 network address (zero SLA and interface
     * identifier bits) is detected; see the Derived strategy class.
     */
     ...
     * RFC 3927/RFC 4291 § 2.5.6 (IPv4/IPv6).
     */
    public function isLinkLocal(): bool;

    /**
     * Whether the IP is a loopback address, according to
     * RFC 1122 § 3.2.1.3/RFC 4291 § 2.5.3 (IPv4/IPv6).
     */
    public function isLoopback(): bool;

    /**
     * Whether the IP is a multicast address, according to RFC 5771/RFC 4291
     * § 2.7 (IPv4/IPv6).
     */
     ...
     * to RFC 1122 § 3.2.1.3/RFC 4291 § 2.5.2 (IPv4/IPv6).
     */
